...
export default function NavBar () {
  ...
  return (
    <div className="flex flex-row w-[95%] py-4 h-15 self-center justify-between items-center gap-5 border-neutral-500 mb-28">
      ...
      {/* Button */}
      <button className={`${jetbrains_mono.className} flex relative cursor-pointer text-sm py-1 px-3 hover:text-green-400 hover:text-xs transition-all ease-in-out duration-200`}>
